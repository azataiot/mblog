...
class changePasswordForm(FlaskForm):
    ...
    password = PasswordField("Жаңа Құпия Сөз", validators=[DataRequired(),EqualTo("password2","Passwords must match")])
    password2 = PasswordField("Құпия сөзді Растау", validators=[DataRequired(),EqualTo("password","Passwords must match")])
